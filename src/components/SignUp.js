            ...
            <div className = "container">
                <div className = "left">
                        ...
                        <form onSubmit={this.submit} method="post">
                            <div className = "ip">
                                <input type="text" placeholder="Name" required value={this.name} onChange={this.changeName} size="60" style={{height: '30px'}}/><br/><br/>
                                <input type="email" placeholder="Email" required value={this.email} onChange={this.changeEmail}  size="60" style={{height: '30px'}}/><br/><br/> 
                                <input type="text" placeholder="Mobile number" required value={this.mobile} onChange={this.changeMobileNumber}  size="60" style={{height: '30px'}}/><br/><br/>         
